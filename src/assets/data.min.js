...
const data = {
    ...
    Home: {
        introduction: "I am a student of Bachelor of Technology in Computer Science Engineering from Budge Budge Institute of Technology",
        resumeLink: "1voK-cB3SkMEOYVCTRkYau50kk99ItkQ2",
        typedElement: ["Sakshi Singh", "Full Stack Developer", "Tech Enthusiast", "Data Structure and Algorithms", "MEAN/MERN Stack Developer", "Programmer", "Open Source Contributor"]
    },
    About: {
        ...identity,
        NavTabs: [{
        ...
        about: {
            "tech-stats": "Full Stack Web Developer, Programmer, Open Source Contributor And Tech Enthusiast",
            bio: "Computer Science and Engineering student with a strong academic background, holding a Bachelor of Technology degree. She excels in coding, earning a 5-star rating in C Language on HackerRank and receiving the Outreach Scholarship Batch-9 from GirlScript.Tech.I am a proficient web developer, showcasing her skills through projects like 'Dummy MERN,' 'Serving Peace,' and a 'RazorPay Clone.' Her internship at CodeClause highlights her problem-solving abilities and adaptability to new technologies.Driven by a passion for technology and a commitment to excellence, Sakshi continues to grow and make a positive impact in the world of tech.",
            "IDE, Editors & Tools": ["Intellij", "PyCharm", "Atom", "Python 3.9", "CodeBlocks", "VS Code"]
        },
        skills: [
            [{
                skill: "HTML",
        ...
        education: [{
            ...
            duration: "2020 - 2024",
            percentage: "CGPA:8.68"
        }, {
            animationClass: "Left right",
            textAlignment: "left",
            degree: "XII (Senior Secondary), PCM with Computer Science",
            college: "St. Karen's Secondary Education,Patna (CBSE Board)",
            duration: "Year of Completion : 2019",
            percentage: "Percentage : 84.34%"
        }, {
            animationClass: "Right left",
            textAlignment: "right",
            degree: "X (Secondary)",
            college: "Krishna Niketan,Patna (CBSE Board)",
    ...
    Portfolio: [{
        ...
        delay: "0.5s",
        project: "Serving_Peace",
        description: "Offered a platform for individuals to access free counseling services and seek professional help for mental health concerns.",
        placement: "top"
    }, {
        animationClass: "slideInUp",
        delay: "0",
        project: "RazorPay_Clone",
        description: "It helps processes online payments for online as well as offline businesses. Razorpay allows you to accept credit cards, debit cards, netbanking, wallet, and UPI payments with the Mobile App integration.",
        placement: "top"
    }, {
        animationClass: "rotateInDownRight",
        delay: "0.5s",
        project: "Dummy_Mern",
        description: "Implemented CRUD operations, enabling users to interact with the data dynamically.",
        placement: "top"
    }, {
        animationClass: "rotateInUpLeft",
        delay: "0.5s",
        project: "Inc_Dec_CounterApp",
        description: " About This is basic react app , we can increment the digit just by clicking on '+' icon and also decrement the digit by clicking on '-' icon.",
        placement: "bottom"
    }, {
        animationClass: "slideInDown",
        delay: "0",
        project: "Product_card",
        description: "project is a visually appealing and responsive display element created using HTML and CSS. It showcases essential product information, such as an image, title, price, and description, in a compact and organized format.",
        placement: "bottom"
    }, {
        animationClass: "rotateInUpRight",
        delay: "0.5s",
        project: "Snake__Game__Nokia",
        description: "Revisit nostalgia with Snake Game Nokia edition! Built using HTML and JavaScript, this classic game faithfully recreates the iconic experience of maneuvering a pixelated snake to eat and grow. Enjoy hours of retro fun right in your browser.",
        placement: "bottom"
    }],
    // Training: {
    ...
    Achievement: [{
        animationClass: "Left",
        description: "4 ★ in Problem Solving with 3200+ points on HackerRank.",
        image: "HackerRank"
    }, {
        animationClass: "Up",
        description: "Won 𝗛𝗮𝗰𝗸𝘁𝗼𝗯𝗲𝗿𝗳𝗲𝘀𝘁 𝟮𝟬𝟮𝟮 T-shirt by creating more than 4+ Pull Request.",
        image: "Hacktoberfest"
    }, {
        animationClass: "Right",
        description: "Selected as a Scholarship receipent in Girlscript Foundation",
        image: "DataScience"
    }],
    Contact: [{
        animationClass: "Left",
    ...
    Social: [
        [{
            ...
            link: "https://www.linkedin.com/in/sakshi-kumari-she-her-248b70204/",
            class: "fab fa-linkedin-in",
            name: "LinkedIn",
            placement: "top"
        }, {
            link: "https://leetcode.com/ID__NO/",
            class: "fas fa-laptop-code",
            name: "Leetcode",
            placement: "top"
        }, {
            link: "https://www.hackerrank.com/abhask865?hr_r=1",
