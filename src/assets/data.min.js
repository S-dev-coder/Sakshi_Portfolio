...
const data = {
    ...
    Portfolio: [{
        ...
        description: "Scalable room-booking system built with Next.js, Node.js, Express, MongoDB & TypeScript. JWT auth + RBAC for multi-role access. TypeScript scheduling algorithms cut booking conflicts by 75%.",
        placement: "top"
    }, {
        animationClass: "slideInUp",
        delay: "0",
        project: "Expense-Tracker",
        description: "Full-stack financial management app using Clean Architecture & MVC patterns. 80% unit-test coverage via Repository Pattern. Tech: React.js, Node.js, Express.js, MongoDB, TypeScript.",
        placement: "top"
    }, {
        animationClass: "rotateInDownRight",
        delay: "0.5s",
        project: "Customer-Success-Platform",
        description: "MERN-based Customer Success Platform at Promact InfoTech. Automated notifications, secure user auth, real-time email updates, and PDF export functionality.",
        placement: "top"
    }, {
        animationClass: "rotateInUpLeft",
        delay: "0.5s",
        project: "AI-Survey-Automation",
        description: "AI-driven automation pipeline using Python, LangChain & LLMs at Kantar MNC. Reduced manual programming time by 85%, optimizing enterprise workflow efficiency.",
        placement: "bottom"
    }, {
        animationClass: "slideInDown",
        delay: "0",
        project: "Dummy_Mern",
        description: "MERN stack CRUD application implementing RESTful APIs with React frontend, Node.js backend, and MongoDB database. Clean separation of concerns.",
        placement: "bottom"
    }, {
        animationClass: "rotateInUpRight",
        delay: "0.5s",
        project: "Sakshi_Portfolio",
        description: "Personal developer portfolio built with Angular, showcasing projects, skills, and experience. Features dark mode, animations, and responsive design.",
        placement: "bottom"
    }],
    // Training: {
